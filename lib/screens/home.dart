                      ...
                      child: isConnectedGlobal
                          ? isLoadingGlobalData
                              ...
                              : Consumer<CountryNotifier>(
                                  builder: (context, notifier, child) => Theme(
                                    data: Theme.of(context).copyWith(
                                    ...
                                    child: RefreshIndicator(
                                      onRefresh: () async {
                                        if (DefaultTabController.of(context)
                                          ...
                                          if (globalDropDownValue == 'Today') {
                                            print(
                                                'getting today\'s global data');
                                            _getGlobalStats('/all');
                                          } else if (globalDropDownValue ==
                                              'Yesterday') {
                                            print(
                                                'getting yesterday\'s global data');
                                            _getGlobalStats(
                                                '/all?yesterday=true');
                                          } else if (globalDropDownValue ==
                                              'Two Days Ago') {
                                            print(
                                                'getting two days ago global data');
                                            _getGlobalStats(
                                                '/all?twoDaysAgo=true');
                                          }
                                          ...
                                          if (countryDropDownValue == 'Today') {
                                            print(
                                                'getting today\'s country data');
                                            _getSpecificCountryStats(
                                                '/countries/${notifier.country}?strict=false');
                                          } else if (countryDropDownValue ==
                                              'Yesterday') {
                                            print(
                                                'getting yesterday\'s country data');
                                            _getSpecificCountryStats(
                                                '/countries/${notifier.country}?yesterday=true&strict=false');
                                          }
                                        } else if (DefaultTabController.of(
